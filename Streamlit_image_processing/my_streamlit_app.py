...
#--User Authentiction ----
name = ["Gnanaprakash","guest"]
username = ["sgprakash","guest"]

f_p = Path(__file__).parent / "h_pw.pkl"
with f_p.open("rb") as file:
    h_p = pickle.load(file)
...
auth = stauth.Authenticate(credentials,"Login page","abcd",cookie_expiry_days=12)    
name, auth_status, username = auth.login("Login","main")
print(name,username,auth_status)
if auth_status == False and not username:
    ...
    if my_list == my_list_of_image_processing[1]:
        ...
        pass
if auth_status == False and username:
